...
WebUI.callTestCase(findTestCase('Pages/Register/Verify Content Register Page'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Register/Input Nomor Hp'), [('nomor_hp') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Register/Input Kota'), [('kota') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Register/Input Alamat'), [('alamat') : ''], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Register/Tap Button Daftar'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Pages/Register/Read Error Message/Read Error Msg Empty Nama'), [('expected') : ''], FailureHandling.STOP_ON_FAILURE)
