...
Mobile.callTestCase(findTestCase('Pages/Login/Input Email'), [('email') : 'unregisteredmail@gmail.com'], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Login/Input Password'), [('password') : '12345678'], FailureHandling.STOP_ON_FAILURE)
