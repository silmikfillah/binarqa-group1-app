...
WebUI.callTestCase(findTestCase('Pages/Edit Product/Edit Kategori Produk'), [('kategoriProduk') : ''], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Edit Product/Verify Error Message - Kategori Produk'), [:], FailureHandling.STOP_ON_FAILURE)