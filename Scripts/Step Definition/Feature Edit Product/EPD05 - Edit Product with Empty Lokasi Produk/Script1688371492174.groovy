...
WebUI.callTestCase(findTestCase('Pages/Edit Product/Edit Lokasi Produk'), [('lokasiProduk') : ''], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('Pages/Edit Product/Tap Terbitkan Button'), [:], FailureHandling.STOP_ON_FAILURE)
WebUI.callTestCase(findTestCase('Pages/Edit Product/Verify Error Message - Lokasi Produk'), [:], FailureHandling.STOP_ON_FAILURE)