...
WebUI.callTestCase(findTestCase('Pages/Edit Product/Edit Harga Produk'), [('hargaProduk') : 'abcdef'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Edit Product/Edit Deskripsi Produk'), [('deskripsiProduk') : 'Baju dengan kualitas terbaik'], 
...
WebUI.callTestCase(findTestCase('Pages/Edit Product/Verify Error Message - Harga Produk'), [:], FailureHandling.STOP_ON_FAILURE)
