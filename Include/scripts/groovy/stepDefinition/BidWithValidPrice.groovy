...
class BidWithValidPrice {
	...
	@When("user memasukan harga tawaran {string}")
	public void user_memasukan_harga_tawaran(String harga) {
		WebUI.callTestCase(findTestCase('Pages/Buyer Bid/Input Harga Tawar'), [('harga') : harga], FailureHandling.STOP_ON_FAILURE)
	}

	@When("user click di tombol Kirim button")
	public void user_click_di_tombol_Kirim_button() {
