...
class UpdateBatalkanTransaksi {
	@When("seller click Batalkan Transaksi radio button")
	public void seller_click_Batalkan_Transaksi_radio_button() {
		WebUI.callTestCase(findTestCase('Pages/Update Status Seller/Click Batalkan transaksi'), [:], FailureHandling.STOP_ON_FAILURE)
	}
